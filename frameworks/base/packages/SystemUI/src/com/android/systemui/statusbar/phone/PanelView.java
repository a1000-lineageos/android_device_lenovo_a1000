...
public abstract class PanelView extends FrameLayout {
    ...
    protected void notifyBarPanelExpansionChanged() {
        /* A1000: keyguard can be shown before setBar() has run (KeyguardViewMediator
         * -> StatusBar.showKeyguardImpl -> instantExpandNotificationsPanel), leaving
         * mBar null and crashing SystemUI in a loop until ActivityManager kills it. */
        if (mBar == null) {
            return;
        }
