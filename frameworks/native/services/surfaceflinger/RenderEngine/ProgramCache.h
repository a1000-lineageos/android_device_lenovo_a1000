...
public:
    ...
    public:
        enum {
            ...
            /* A1000: перестановка каналов под панель. Она нужна ТОЛЬКО при
             * выводе на экран; в снимок экрана попадать не должна, иначе
             * screencap и превью в «недавних» выходят с обменянными R и B. */
            SWIZZLE_OFF             =       0x00000000,
            SWIZZLE_ON              =       0x00000080,
            SWIZZLE_MASK            =       0x00000080,
        };
        ...
        inline bool hasSwizzle() const {
            return (mKey & SWIZZLE_MASK) == SWIZZLE_ON;
        }
